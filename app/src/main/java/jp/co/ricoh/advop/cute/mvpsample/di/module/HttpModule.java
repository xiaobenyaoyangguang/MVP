...
import jp.co.ricoh.advop.cute.mvpsample.data.http.BaseUrlManagerInterceptor;
import jp.co.ricoh.advop.cute.mvpsample.data.http.NullOnEmptyConverterFactory;
